...
const config = {
  ...
  strategy: {
    ...
    researchMaxHours: parseFloat(process.env.RESEARCH_MAX_HOURS) || 48,  // Max 48h to resolve
    researchMinScore: parseFloat(process.env.RESEARCH_MIN_SCORE) || 4,   // Min research potential
  },
  scanner: {
